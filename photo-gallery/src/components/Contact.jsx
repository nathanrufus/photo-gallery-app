            ...
            <div class="text-center ">
              <div class="relative flex flex-col items-center">
                ...
                <h1 class="text-5xl font-bold dark:text-white">
                  {" "}
                  Our <span class="text-blue-500"> Contact</span>{" "}
                </h1>
              ...
              <p class="mb-16 text-base text-center text-gray-500">
                You can contact me using the credentials below
              </p>
            </div>
          </div>
          <div class="flex flex-wrap mb-8 -mx-4">
            <div class="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
              <div class="h-full py-12 text-center transition-all rounded-lg shadow dark:bg-gray-800 bg-gray-50 hover:shadow-lg">
                <div class="inline-flex items-center justify-center w-12 h-12 mb-6 text-gray-100 bg-blue-500 rounded-full dark:bg-blue-500">
                  <svg
